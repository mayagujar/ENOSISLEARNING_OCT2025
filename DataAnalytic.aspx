<%@ Page Title="" Language="C#" MasterPageFile="~/LEARNING.Master" AutoEventWireup="true" CodeBehind="DataAnalytic.aspx.cs" Inherits="ENOSISLEARNING.DataAnalytic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <h1 style="margin-left:44px;position:relative;top:10px;font-weight:900;font-size:20px">Data Analytics Training Modules</h1>
    <div class="container">
