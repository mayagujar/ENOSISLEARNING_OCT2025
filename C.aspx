<%@ Page Title="" Language="C#" MasterPageFile="~/LEARNING.Master" AutoEventWireup="true" CodeBehind="C.aspx.cs" Inherits="ENOSISLEARNING.C" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <h1 style="margin-left:44px;position:relative;top:10px;font-weight:900;font-size:20px">C Language Training Modules</h1>
    <div class="container">
