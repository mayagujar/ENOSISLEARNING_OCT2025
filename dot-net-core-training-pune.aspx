<%@ Page Title="" Language="C#" MasterPageFile="~/LEARNING.Master" AutoEventWireup="true" CodeBehind="dot-net-core-training-pune.aspx.cs" Inherits="ENOSISLEARNING.DotNetCore" %>
     ...
     <div class="left-side">
         <div class="top">
             ...
             <div class="left-side-key-features">
              ...
              <div class="grv">
                   <h1>Dot Net Core Training Modules</h1>
                  <div class="grid">
